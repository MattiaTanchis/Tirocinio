...
(5, 'Always code as if the guy who ends up m INTEGERaining your code will be a violent psychopath who knows where you live.', 'John Woods'), 
...
(8, 'If you have to spend effort looking at a fragment of code and figuring out what it''s doing, then you should extract it INTEGERo a function and name the function after the "what".', 'Martin Fowler'), 
...
INSERT INTO Persona (id_persona, nome, citta) VALUES
(1,'Mattia','Romanengo'),
(2,'Giacomo','Milano'),
(3,'Asia','Crema'),
(4,'Marco','Crema'),
...
INSERT INTO Account (id_account, nickname, id_persona) VALUES
(1213,'TANK',1),
(2314,'Asietta01',3),
(4542,'KevBB',5),
(3132,'Marco314',4);

INSERT INTO Ordine (id_ordine, numero_ordine, id_account) VALUES
(321,1,1213),
(423,1,2314);